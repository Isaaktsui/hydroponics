...
// Dose state machines
enum DoseState {IDLE, DOSING, WAITING};
DoseState acidState = IDLE, baseState = IDLE, nutrState = IDLE;
unsigned long acidDoseStart = 0, acidWaitStart = 0;
unsigned long baseDoseStart = 0, baseWaitStart = 0;
unsigned long nutrDoseStart = 0, nutrWaitStart = 0;
